...
bool TimerManagerComponent::Initialize()
{
  ...
  glm::vec3 newTrans4(mParent()->GetComponent(TransformComponent)->mPositionX() - 2, mParent()->GetComponent(TransformComponent)->mPositionY(), 5);
  ...
  glm::vec3 newTrans(mParent()->GetComponent(TransformComponent)->mPositionX() - 1, mParent()->GetComponent(TransformComponent)->mPositionY(), 5);
